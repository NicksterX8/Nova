...
inline void* safe_realloc(void* old, size_t size) {
...
static_assert(sizeof(SmallVectorSizeType<void*>) == 4, "thing");
static_assert(sizeof(SmallVectorTemplateCommon<void*>) == 16);
